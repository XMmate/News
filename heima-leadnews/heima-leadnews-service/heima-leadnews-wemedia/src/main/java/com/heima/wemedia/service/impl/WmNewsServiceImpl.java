...
public class WmNewsServiceImpl extends ServiceImpl<WmNewsMapper, WmNews> implements WmNewsService {
    ...
    @Override
    public ResponseResult list_vo(NewsAuthDto newsAuthDto) {
        List<WmNews> wmNews = wmNewsMapper.selectList(new QueryWrapper<WmNews>());
    ...
    @Override
    public ResponseResult auth_fail(NewsAuthDto newsAuthDto) {
    ...
    @Override
    public ResponseResult auth_pass(NewsAuthDto newsAuthDto) {
        WmNews wmNews = wmNewsMapper.selectById(newsAuthDto.getId());
